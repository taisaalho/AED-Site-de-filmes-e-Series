...
def function1():
    ...
    #Panel para ListBox
    panel1 = PanedWindow(window, width = 300, height = 300, bd = "3", relief = "sunken")
    panel1.place(x=10, y=30)
    panel2 = PanedWindow(window, width = 300, height = 300, bd = "3", relief = "sunken")
    ...
    # Buttons
    btn_remove=Button(window,  text = "Remover favorito",width = 15, height = 2,bg="orange", fg = "black", command = remover_favorito)
    btn_remove.place(x=100, y=350)
    btn2_remove=Button(window, text="Remover visto", width=15, height=2,bg="orange", fg="black", command=remover_visto)

...
#Campo de título
titulo = Label(window, text="Good Omens (2019)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
...
cast2 = Label(window, text="Michael Sheen, David Tennant", font=("Calisto MT", "10"))

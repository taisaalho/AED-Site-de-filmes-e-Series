...
#Campo de título
titulo = Label(window, text="Cobra Kai (2018)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
...
cast2 = Label(window, text="William Zabka, Ralph Macchio", font=("Calisto MT", "10"))

...
#Imagem póster
img = PhotoImage(file="shadow-and-bone-poster.gif")
poster_space.create_image(253, 375, image=img)

#Campo de título
titulo = Label(window, text="Shadow and Bone (2021)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
...
clas2 = Label(window, text="7.7", font=("Calisto MT", "10"))
...
cast2 = Label(window, text="Jessie Mei Li, Ben Barnes", font=("Calisto MT", "10"))
...
videoplayer.load(r"shadow-and-bone-trailer.mp4")

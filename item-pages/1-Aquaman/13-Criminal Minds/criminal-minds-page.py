...
#Campo de título
titulo = Label(window, text="Criminal Minds (2005)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
...
cast2 = Label(window, text="Joe Mantegna, Matthew Gray Gubler", font=("Calisto MT", "10"))

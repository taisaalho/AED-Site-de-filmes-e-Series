...
#Campo de título
titulo = Label(window, text="Rick and Morty (2013)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
...
clas2 = Label(window, text="9.2", font=("Calisto MT", "10"))
...
cast2 = Label(window, text="Justin Roiland, Spencer Grammer", font=("Calisto MT", "10"))
...
def salvar_alteracoes():
    ...
    if val.get() == 1 and val1.get() == 0:
        ...
        f = open("lista_favoritos.txt","a")
        frase = "Rick and Morty (2013) - Visto" + "\n"
        f.write(frase)
        f.close

...
#Campo de título
titulo = Label(window, text="Knives Out (2019)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
...
clas2 = Label(window, text="7.9", font=("Calisto MT", "10"))
...
cast2 = Label(window, text="Daniel Craig, Jamie Lee Curtis", font=("Calisto MT", "10"))

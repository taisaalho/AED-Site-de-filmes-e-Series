...
desc.place(x=350, y=100)

desc2 = Label(window, text="coiso faz coisa", font=("Calisto MT", "10"))
desc2.place(x=415, y=100)

#Campo de trailer
trailer_space = Canvas(window, bg="gray", width=362, height=268, bd=2, relief="sunken")
trailer_space.place(x=335, y=190)
...
eval_space = Canvas(window, bg="gray", width=400, height=441, bd=2, relief="sunken")
...
com_space = LabelFrame(eval_space, text="Comentários", width=380, height=350, bd=2, relief="raised", fg="red", font=("Calisto MT", "10", "bold"))

...
def function20():
    ...
    page.title("Over the Garden Wall")
    page.resizable(0, 0)
    ...
    #Campo de título
    titulo = Label(page, text="Over the Garden Wall (2014)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
    ...
    clas2 = Label(page, text="8.8", font=("Calisto MT", "10"))
    ...
    cast2 = Label(page, text="Elijah Wood, Collin Dean", font=("Calisto MT", "10"))

...
def function5():
    ...
    page.title("Mary Poppins Returns")
    page.resizable(0, 0)
    ...
    #Campo de título
    titulo = Label(page, text="Mary Poppins Returns (2018)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
    ...
    cat2 = Label(page, text="Fantasia, Comédia", font=("Calisto MT", "10"))
    ...
    clas2 = Label(page, text="6.7", font=("Calisto MT", "10"))
    ...
    cast2 = Label(page, text="Emily Blunt, Lin Manuel Miranda", font=("Calisto MT", "10"))

...
def function3():
    ...
    #Campo de título
    titulo = Label(page, text="White Wall (2010)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
    ...
    clas2 = Label(page, text="4.2", font=("Calisto MT", "10"))
    ...
    cast2 = Label(page, text="James Boss, Gary Kohn", font=("Calisto MT", "10"))

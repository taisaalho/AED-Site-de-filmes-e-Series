...
def function11():
    ...
    #Campo de título
    titulo = Label(page, text="Loki (2021)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
    ...
    cat2 = Label(page, text="Ação, Fantasia", font=("Calisto MT", "10"))
    ...
    clas2 = Label(page, text="8.3", font=("Calisto MT", "10"))
    ...
    cast2 = Label(page, text="Tom Hiddleston, Owen Wilson", font=("Calisto MT", "10"))

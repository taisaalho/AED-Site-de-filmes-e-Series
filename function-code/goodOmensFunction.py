...
def function15():
    ...
    #Imagem póster
    img = PhotoImage(file="good-omens-poster.gif")
    poster_space.create_image(253, 375, image=img)

    #Campo de título
    titulo = Label(page, text="Good Omens (2019)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
    ...
    cast2 = Label(page, text="Michael Sheen, David Tennant", font=("Calisto MT", "10"))
    cast2.place(x=400, y=100)

    #Campo de descrição
    desc = Text(page, height=6, width=52, font=("Calisto MT", "10", "bold"))
    desc.place(x=340, y=125)
    desc.insert(1.0, "Ambientada em 2018, a série seguirá o anjo Aziraphale (Sheen) e o demônio Crowley (Tennant), que, acostumados com a vida na Terra, procuram impedir a vinda do anticristo e com ele a batalha final entre o Céu e o Inferno.")
    ...
    videoplayer.load(r"good-omens-trailer.mp4")
    ...
    def remover():
        ...
        coment.set("")
        f = open("com_goodomens.txt", "w", encoding="utf-8")
    ...
    def num_likes():
        f=open("like_goodomens.txt", "r", encoding="utf-8")
        ficheiro=f.readlines()
        f.close()
        count=0
        for linha in ficheiro:

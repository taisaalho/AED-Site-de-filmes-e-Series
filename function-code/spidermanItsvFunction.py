...
def function4():
    ...
    page.title("Spiderman: Into the Spiderverse")
    page.resizable(0, 0)
    ...
    #Campo de título
    titulo = Label(page, text="Spiderman: Into the Spiderverse (2018)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
    ...
    cat2 = Label(page, text="Ação, Animação", font=("Calisto MT", "10"))
    ...
    clas2 = Label(page, text="8.4", font=("Calisto MT", "10"))
    ...
    cast2 = Label(page, text="Shameik Moore, Jake Johnson", font=("Calisto MT", "10"))

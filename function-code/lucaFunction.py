...
def function9():
    ...
    #Campo de título
    titulo = Label(page, text="Luca (2021)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
    ...
    clas2 = Label(page, text="7.5", font=("Calisto MT", "10"))
    ...
    cast2 = Label(page, text="Jacob Tremblay, Jack Dylan Grazer", font=("Calisto MT", "10"))
    ...
    def remover():
        ...
        coment.set("")
        f = open("com_luca.txt", "w", encoding="utf-8")
    ...
    def num_likes():
        f=open("like_luca.txt", "r", encoding="utf-8")
        ficheiro=f.readlines()
        f.close()
        count=0
        for linha in ficheiro:

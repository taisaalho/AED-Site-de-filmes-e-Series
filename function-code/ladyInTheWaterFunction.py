...
def function6():
    ...
    #Campo de título
    titulo = Label(page, text="Lady in the Water (2006)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
    ...
    clas2 = Label(page, text="5.5", font=("Calisto MT", "10"))
    ...
    cast2 = Label(page, text="Bryce Dallas Howard, Paul Giamatti", font=("Calisto MT", "10"))

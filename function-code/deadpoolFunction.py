...
def function2():
    ...
    #Campo de título
    titulo = Label(page, text="Deadpool(2016)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
    ...
    clas2 = Label(page, text="8.0", font=("Calisto MT", "10"))
    ...
    cast2 = Label(page, text="Ryan Reynolds, Morena Baccarin", font=("Calisto MT", "10"))
    ...
    def remover():
        ...
        coment.set("")
        f = open("com_deadpool.txt", "w", encoding="utf-8")
    ...
    def num_likes():
        f=open("like_deadpool.txt", "r", encoding="utf-8")
        ficheiro=f.readlines()
        f.close()
        count=0
        for linha in ficheiro:

...
def function18():
    ...
    #Campo de título
    titulo = Label(page, text="Castle (2009)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
    ...
    cast2 = Label(page, text="Nathan Fillion, Stana Katic", font=("Calisto MT", "10"))
    ...
    def remover():
        ...
        coment.set("")
        f = open("com_castle.txt", "w", encoding="utf-8")
    ...
    def num_likes():
        f=open("like_castle.txt", "r", encoding="utf-8")
        ficheiro=f.readlines()
        f.close()
        count=0
        for linha in ficheiro:

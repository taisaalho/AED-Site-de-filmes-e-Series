...
def function():
    ...
    clas2 = Label(page, text="6.9", font=("Calisto MT", "10"))
    ...
    cast2 = Label(page, text="Jason Momoa, Amber Heard", font=("Calisto MT", "10"))
    ...
    def remover():
        ...
        coment.set("")
        f = open("com_aquaman.txt", "w", encoding="utf-8")
    ...
    def num_likes():
        f=open("like_aquaman.txt", "r", encoding="utf-8")
        ficheiro=f.readlines()
        f.close()
        count=0
        for linha in ficheiro:

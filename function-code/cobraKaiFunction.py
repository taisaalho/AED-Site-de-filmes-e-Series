...
def function12():
    ...
    #Campo de título
    titulo = Label(page, text="Cobra Kai (2018)", fg="#5E239D", font=("Calisto MT", "16", "bold"))
    ...
    cat2 = Label(page, text="Ação, Comédia", font=("Calisto MT", "10"))
    ...
    cast2 = Label(page, text="William Zabka, Ralph Macchio", font=("Calisto MT", "10"))
    cast2.place(x=400, y=100)

    #Campo de descrição
    desc = Text(page, height=6, width=52, font=("Calisto MT", "10", "bold"))
    desc.place(x=340, y=125)
    desc.insert(1.0, "Cobra Kai traz o retorno de Johnny Lawrence (William Zabka) e Daniel LaRusso (Ralph Macchio), os protagonistas de Karatê Kid, mais de 30 anos depois do clássico dos anos 80. Lawrence decide reabrir o dojo Cobra Kai, o que reacende a rivalidade dos dois inimigos de adolescência.")
    ...
    ##videoplayer.load(r"cobra-kai-trailer.mp4")
    ...
    def remover():
        ...
        coment.set("")
        f = open("com_cobrakai.txt", "w", encoding="utf-8")
    ...
    def num_likes():
        f=open("like_cobrakai.txt", "r", encoding="utf-8")
        ficheiro=f.readlines()
        f.close()
        count=0
        for linha in ficheiro:
